  ...
  return (
    <header className='lg:fixed lg:top-0 lg:left-0 w-full'>
      <div className='grid grid-cols-5 gap-y-6 p-6 mx-auto'>
        <div
          className={`${styles.header__logo__wrapper} col-span-2 sm:col-span-1`}
        >
          <h1 className={`${styles.header__logo__wrapper__logo} ts tsf`}>
            <span className='tsl'>IZA</span>
          </h1>
        </div>
        <CalButton className='row-start-2 sm:row-start-1 sm:col-start-2 flex flex-col w-fit items-center md:mr-[8vw] border-white transition-[border] duration-1000 p-2 border-2 [&:has(.tsl.tsa)]:border-main border-solid group hover:bg-main' />
